...
import com.sharkBytesLab.spinTheBottle.databinding.ActivityMenuBinding;
...
public class MenuActivity extends AppCompatActivity implements MaxAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interstitialAd = new MaxInterstitialAd( "e174b870f36a20b8", this );
        ...
        binding.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    intent.putExtra(Intent.EXTRA_SUBJECT, "GO Calculator");
